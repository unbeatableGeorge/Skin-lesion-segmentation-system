...
parser.add_argument('--model_path', type=str, default='./MFSNet.pth')
parser.add_argument('--data_path', type=str, default='./datasets/ISIC2018_Task1_342x256', help='Directory of test images')
parser.add_argument('--save_path', type=str, default='./images', help='Directory where prediction masks will be saved.')
...
model = MFSNet()
state_dict = torch.load(opt.model_path, map_location=torch.device('cpu'), weights_only=True)
